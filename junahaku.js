...
window.onload = function () {
    ...
    if (window.location.href.indexOf("#") !== -1){
        var kayttajanNimi = window.location.href.substring((window.location.href.indexOf("#")+1), window.location.href.length);
        document.getElementById("kirjauduUlosPiilotettava").innerHTML = "<button class=\"btn btn-xs btn-block mustatRajat\" onclick=\"kirjauduUlos()\">Kirjaudu ulos " + kayttajanNimi+"</button>";
